...
public:
	...
	addr_t conv1_core1_start_addr = 0x73100000;
	addr_t conv1_core0_size = 0x00100000;
	addr_t conv1_core1_size = 0x00100000;
	addr_t conv1_core0_end_addr = conv1_core0_start_addr + conv1_core0_size - 1;
	addr_t conv1_core1_end_addr = conv1_core1_start_addr + conv1_core1_size - 1;
	//CONV2 memory address
	addr_t conv2_core0_start_addr = 0x73200000;
	addr_t conv2_core1_start_addr = 0x73300000;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > conv2_core1_end_addr) &&
