...
public:
	...
	addr_t sobelFilter_RS_start_addr = 0x74000000;
	addr_t sobelFilter_RS_size = 0x01000000;
	addr_t sobelFilter_RS_end_addr = sobelFilter_RS_start_addr + sobelFilter_RS_size - 1;
...
int sc_main(int argc, char **argv) {
	...
	bus.ports[13] = new PortMapping(opt.sobelFilter_RS_start_addr, opt.sobelFilter_RS_end_addr);
	...
	bus.isocks[13].bind(sobel_filter_rs.tsock);
